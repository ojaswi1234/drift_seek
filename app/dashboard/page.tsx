...
function Page() {
  ...
  return (
    <div className="flex-1 min-h-screen bg-white py-10 px-6 md:px-12 lg:px-44 overflow-y-auto">
      ...
      <div className="w-full border border-zinc-800 bg-zinc-950 p-6 md:p-10 shadow-2xl transition-all">
        ...
        <div className="mt-8 min-h-[100px]">
          {checking ? (
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="font-mono">
                    <span className={`text-2xl font-bold ${isstatus.statusCode < 400 ? 'text-green-400' : 'text-red-500'}`}>
                      {isstatus.statusCode}
                    </span>
                ...
                {isstatus.diagnostic && (
                  <div className="mt-6 border border-zinc-800 bg-black/50 p-4 relative">
                    <div className="absolute -top-3 left-4 bg-zinc-950 px-2 flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest">Failure_Analysis_Trace</span>
                    </div>
                    
                    <pre className="text-xs font-mono text-red-400/80 leading-relaxed overflow-x-auto py-2">
                      {isstatus.diagnostic.split('|').map((part, i) => (
                        <div key={i} className="py-0.5">&gt; {part.trim()}</div>
                      ))}
                    </pre>
            ...
            <div className="flex items-center gap-2 text-zinc-700 font-mono text-[10px] uppercase tracking-[0.2em]">
      ...
      <div className="w-full h-full grid md:grid-col-2 justify-center mt-4">
            <div className="bg-zinc-600l">
